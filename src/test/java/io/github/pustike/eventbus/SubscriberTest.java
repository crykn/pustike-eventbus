...
public class SubscriberTest extends TestCase {
    ...
    public void testCreate() {
        Subscriber s1 = Subscriber.create(bus, this, getTestSubscriberMethod("recordingMethod"), 0);
        ...
        Subscriber s2 = Subscriber.create(bus, this, getTestSubscriberMethod("threadSafeMethod"), 0);
    ...
    public void testInvokeSubscriberMethod_basicMethodCall() throws Throwable {
        ...
        Subscriber subscriber = Subscriber.create(bus, this, method, 0);
    ...
    public void testEquals() throws Exception {
        ...
        new EqualsTester().addEqualityGroup(Subscriber.create(bus, "foo", charAt, 0),
                Subscriber.create(bus, "foo", charAt, 0))
                .addEqualityGroup(Subscriber.create(bus, "bar", charAt, 0))
                .addEqualityGroup(Subscriber.create(bus, "foo", concat, 0))
                .testEquals();
    }
    ...
    /**
     * Records the provided object in {@link #methodArgument} and sets {@link #methodCalled}.  This method is called
     * reflectively by Subscriber during tests, and must remain public.
